...
export default function CabinetInfoPanel(props: InfoModalProps) {
  ...
  return (
    <PageContainer>
      <div className='bg-background flex flex-col rounded-xl sm:w-[300px] md:w-[370px]'>
        ...
        <Tabs defaultValue='info' className='gap-0'>
          ...
          >
            ...
            <Button variant='default' className='mx-auto my-6 mb-2 h-9 text-xs'>
              Báo cáo sự cố
            </Button>
          </TabsContent>
          ...
          <TabsContent
            value='info'
            className='flex flex-col gap-1.5 pt-1.5 pr-[5px] pl-1.5 [&_[data-slot=card]]:shadow-none'
          >
