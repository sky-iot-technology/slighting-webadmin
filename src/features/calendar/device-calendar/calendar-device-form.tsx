...
export default function CalendarDeviceForm({
  ...
  const defaultValues =
    ...
    ((initialData
      ...
      : {
          ...
          schedules: [{ time: null, actionType: null }]
  ...
  const { watch, setValue, trigger, setError, getValues } = form;
  ...
  }, [repeat, setValue, setError, getValues]);
                      ...
                      <FormItem className='col-span-2'>
                        ...
                        <FormControl>
                          <Input
                            ...
                            placeholder={t(
                              'calendar.enter_calendar_name' as any
                            )}
                            {...field}
                          />
                        </FormControl>
