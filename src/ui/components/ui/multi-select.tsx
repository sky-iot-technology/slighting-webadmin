        ...
        >
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              ...
                              className='-m-0.5 ml-2 flex h-4 w-4 cursor-pointer items-center rounded-sm p-0.5 hover:bg-white/20 focus:ring-1 focus:ring-white/50 focus:outline-none'
                            >
                              <XCircle
                                className={cn(
                                  'h-3 w-3',
          ...
          >
            <Command>
              ...
              <CommandList
                className={cn(
                  'multiselect-scrollbar dark:bg-action max-h-[40vh] overflow-y-auto',
